...
def execution_plan(workers, config):
    ...
    # ip = workers.local_worker().get_node_ip()
    # port = workers.local_worker().find_free_port()
    # print(ip, port)
    # print('remote_workers_num:', len(workers.remote_workers()))
    # for i, worker in enumerate(workers.remote_workers()):
    #     print(i, ray.get(worker.get_node_ip.remote()))
...
register_trainable("DDPPO_CUSTOM", DDPPOTrainer)